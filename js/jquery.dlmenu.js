...
;( function( $, window, undefined ) {
	...
	$.DLMenu.prototype = {
		...
		_config : function() {
			...
			this.$el.find( 'ul.dl-submenu' ).prepend( '<li class="dl-back"><a href="#">' +
				'<svg class="cat-back-icon" xmlns="http://www.w3.org/2000/svg" width="5.13" height="9.59" viewBox="0 0 5.13 9.59">\n' +
